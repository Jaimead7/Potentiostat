#include  "Circuit.h"
  ...
  void Circuit::readWECurrent(float& rawValue, float& filterValue) {
    ...
    */
    ...
    rawValue = voltageToWECurrent(float_t(mV)/1000.0) * 1000000.0;
